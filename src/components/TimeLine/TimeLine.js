...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        Me chamo Elvis Felix, apaixonado por tecnologia, desde os primeiros passos no mundo da codificação, mergulhei de cabeça em projetos complexos, explorando a vastidão desse universo tecnológico.<br/>
        Sempre buscando conhecimentos na aérea front-end.<br/>
