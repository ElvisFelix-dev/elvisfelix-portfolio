export const projects = [
  ...
  {
    title: 'Leads na Mão',
    description: "CRM Imobiliária.",
    image: '/images/leadsnamao.png',
    tags: ['ReactJS', 'Mongodb', 'EmailJS', 'NodeJS', 'Express'],
    visit: 'https://leadsnamao.netlify.app',
    id: 11,
  },
  {
    title: 'Leads na Mão',
    description: "Plataforma para imobiliária.",
    image: '/images/imosmart.png',
    tags: ['ReactJS', 'Mongodb', 'NodeJS', 'Cloudinary'],
    visit: 'https://imosmart.netlify.app',
    id: 12,
  },
  {
    title: 'Lembrou',
    description: "Plataforma para imobiliária.",
    image: '/images/lembrou.png',
    tags: ['ReactJS', 'Mongodb', 'NodeJS', 'Google-charts'],
    visit: 'https://lembrou.netlify.app',
    id: 13,
  },
  {
    title: '2System',
    description: "Site para empresa.",
    image: '/images/2system.png',
    tags: ['ReactJS', 'Tailwindcss', 'Firebase'],
    visit: 'https://2system.netlify.app',
    id: 1,
  },
  {
    title: 'LocalPoint',
    description: "Plataforma para marcação de ponto.",
